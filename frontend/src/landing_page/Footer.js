    ...
    return ( 
        ...
        <div className='container mt-5' >
            <div className='row mt-5'>
                ...
                <div className='col'>
                    <p className='fs-5'><b> Company </b> </p>
                       
                            <a href='' className='text-decoration-none text-muted'>About</a><br/>
                            <a href='' className='text-decoration-none text-muted'>Products</a><br/>
                            <a href='' className='text-decoration-none text-muted'>Pricing</a><br/>
                            <a href='' className='text-decoration-none text-muted'>Referral programme</a><br/>
                ...
                <div className='col'>
                    <p className='fs-5'> <b> Support</b> </p>
                    <div>
                    <a href='' className='text-decoration-none text-muted'>Contact </a><br/>
                        ...
                        <a href='' className='text-decoration-none text-muted'> Videos </a><br/>
                    </div>  
                </div>
                <div className='col'>
                    <p className='fs-5'><b>Account</b></p>
